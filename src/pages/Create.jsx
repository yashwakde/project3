...
const Create = () => {
  ...
  return (
    <div className="w-full bg-[url(https://i.pinimg.com/736x/2e/b0/33/2eb0336898648e83cdb8182c04e9b4e2.jpg)] bg-cover mt-10 flex justify-center items-center rounded-md relative border-6 border-white p-4 md:mt-5">
      <div className="absolute text-xl md:text-6xl font-thin w-full flex justify-between px-4 text-white">
        <h1>Add</h1>
        <h1>Recipe</h1>
      </div>
      ...
      <form
        ...
        className="w-full max-w-xl md:max-w-[30vw] bg-[#d6d5d0]/30 p-6  rounded-lg backdrop-blur-xl flex flex-col space-y-2 text-sm md:text-[15px]"
      >
        <input
        ...
        />
        <small className="text-red-800">{errors.image?.message}</small>
